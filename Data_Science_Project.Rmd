...
$\boxed{ E[\log(I_{t,s})]=\beta_0+\beta_1\cdot g_{t,s}+\beta_2\cdot p_{t,s}+\beta_3\cdot l_{t,s}+\beta_4\cdot b_{s}+\beta_5\cdot s_{t,s}+\beta_6\cdot y_{t,s}+\beta_6\cdot f_{t,s}+\beta_7\cdot t+ \beta_8 \cdot m_{t-1} +\log( n_{t,s}) }$
...
kableExtra::kable( broom::tidy(fit_grade), align = "c")
...
f_to_a = 1-round(exp(4*-.3189), digits = 3)
...
kableExtra::kable( broom::tidy(fit_law), align = "c")
