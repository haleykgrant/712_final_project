...
kableExtra::kable( kbl, align = "c" , digits = 4)%>%
...
kableExtra::kable( kbl2, align = "c" , digits = 4)%>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover"))
```
...
bans_est = 1-exp(-0.2604)
bans_ci_u = 1-exp(-0.2604-	1.96*0.1226)
bans_ci_l = 1-exp(-0.2604+	1.96*0.1226)

access_est = 1-exp(-0.0666)
access_ci_u = 1-exp(-0.0666	-1.96*0.0274)
access_ci_l = 1-exp(-0.0666	+1.96*0.0274)

kableExtra::kable(data.frame(Variable = c("Access Laws","Bans"), Estimate = -1*c(access_est,bans_est), `C.I Lower`= -1*c(access_ci_u,bans_ci_u),`C.I Upper`= -1*c(access_ci_l,bans_ci_l)  ), digits = 3)%>%
...
kableExtra::kable( kbl3, align = "c" , digits = 4)%>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover"))
...
bans_est = 1-exp(-0.4477)
bans_ci_u = 1-exp(-0.4477	-1.96*0.1708)
bans_ci_l = 1-exp(-0.4477	+1.96*0.1708)

access_est = 1-exp(-0.1089)
access_ci_u = 1-exp(-0.1089-1.96*	0.0378)
access_ci_l = 1-exp(-0.1089+1.96*	0.0378)


trans_est =  1-exp(0.2066)
trans_ci_u =  1-exp(0.2066-1.96*	0.0872)
trans_ci_l =  1-exp(0.2066+1.96*	0.0872)

screen_est = 1-exp(0.0722)
screen_ci_u = 1-exp(0.0722-1.96*	0.0369)
screen_ci_l = 1-exp(0.0722+1.96*	0.0369)

kableExtra::kable(data.frame(Variable = c("Access Laws","Bans","Transport Laws", "Screening Laws"), Estimate = -1*c(access_est,bans_est, trans_est, screen_est), `C.I Lower`= -1* c(access_ci_u,bans_ci_u, trans_ci_u, screen_ci_u),`C.I Upper`=-1*c(access_ci_l,bans_ci_l, trans_ci_l,screen_ci_l) ), digits = 3)%>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover"), full_width = F)
