...
__Note__: population was not used as a variable but as an offset term in the model (coefficient not estimated but set to be 1).

More formally, the model is:

$ math equations I don't want to write rn$
